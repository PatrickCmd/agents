...
# print(RESEND_API_KEY, MAIL_FROM, MAIL_TO, SENDER_NAME, RESEND_API_URL, RESEND_REQUEST_TIMEOUT)


@function_tool
def send_email_sendgrid(subject: str, html_body: str) -> Dict[str, str]:
